...
<script>let smp = document.getElementById('iframe-smp'); window.addEventListener("message", function(e) {if (e.data.contains(smp.src)) smp.height = e.data.slice(0,5);});</script>
</div>
