...
<iframe id="iframe-smp" width="328px" height="210px" src="https://smp.junhaochia.repl.co/192010363" style="border: 0px;" onload="document.getElementById('iframe-smp') = document.getElementById('iframe-smp').contentWindow.document.body.scrollHeight + 'px'"></iframe>
</div>
