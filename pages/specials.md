...
<script>let smp = document.getElementById('iframe-smp'); window.addEventListener("cors_event", function(e) {if (e.data.includes(smp.src)) smp.height = e.data.slice(0,5);});</script>
</div>
